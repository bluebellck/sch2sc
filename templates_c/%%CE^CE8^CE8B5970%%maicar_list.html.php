<?php /* Smarty version 2.6.18, created on 2017-07-05 14:46:07
         compiled from admin/maicar_list.html */ ?>
...
<div class="colorarea01">
	<div class="search clearfix">
		<div class="searchL">
			<ul class="menulist">
				<li><a href="#" class="add">卖车信息列表</a></li>
			</ul>
		</div>
		<div class="searchR">
			<form action="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=maicar" method="get" name="form2">
			<input type="hidden" name="m" value="maicar">
	...
	<form action="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=maicar" method="POST" name="form" onSubmit="return listsubmitconfirm(this.form)">
	<table cellspacing="0" cellpadding="0" width="100%"  class="listtable">
	<tr><th width="30">选择</th><th>ID</th><th align="left">品牌 - 车型</th><th>颜色 - 排量 - 变速箱 - 里程 - 进口/国产</th><th>上牌日期</th><th>联系人 - 电话</th><?php if ($this->_tpl_vars['setting']['version'] == 3): ?><th>城市</th><?php endif; ?><th>描述</th><th>评估价格</th><th>发布时间</th><th>评估时间</th><th width="60">操作</th></tr>
...
-<?php echo $this->_tpl_vars['cars']['city']; ?>
	...
	<td align="center"><?php echo $this->_tpl_vars['cars']['p_price']; ?>
</td>
	<td align="center"><?php echo $this->_tpl_vars['cars']['p_addtime']; ?>
</td>
	<td align="center"><?php echo $this->_tpl_vars['cars']['p_assesstime']; ?>
</td>
	<td align="center" class="rightmenu"><!--<a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=maicar&a=assess&id=<?php echo $this->_tpl_vars['cars']['p_id']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
">评估</a> | --><a href="javascript:if(confirm('ID:<?php echo $this->_tpl_vars['cars']['p_id']; ?>
&nbsp;确实要删除吗?'))location='<?php echo $this->_tpl_vars['adminpage']; ?>
?m=maicar&a=del&id=<?php echo $this->_tpl_vars['cars']['p_id']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
'">删除</a></td>
	</tr>
...
?m=maicar&a=bulkdel&page=<?php echo $this->_tpl_vars['page']; ?>
