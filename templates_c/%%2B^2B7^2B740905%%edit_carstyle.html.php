<?php /* Smarty version 2.6.18, created on 2017-07-07 09:21:20
         compiled from admin/edit_carstyle.html */ ?>
...
?m=carmodel">
		<table cellspacing="0" cellpadding="0" width="100%"  class="maintable">
                <th>款式名称：</th>
                <td>
                     <input name="b_name4"  type="text" id="b_name4" size="20" value="<?php echo $this->_tpl_vars['subsubsublist']['b_name']; ?>
" datatype="s" nullmsg="请填写款式名称！"/>
                </td>
			</tr>
			<tr>
				<th></th>
...
">
                        <input type="hidden" name="b_id" value="<?php echo $this->_tpl_vars['subsubsublist']['b_id']; ?>
">
