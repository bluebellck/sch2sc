<?php /* Smarty version 2.6.18, created on 2017-07-07 14:06:31
         compiled from admin/add_model.html */ ?>
...
?m=model&a=list" class="list">返回车型列表</a></li>
			</ul>
		</div>
	</div>
...
?m=model">
		<table cellspacing="0" cellpadding="0" width="100%"  class="maintable">
			<tr>
				<th>车型名称</th>
				<td><input name="s_name" type="text" id="s_name" size="30" value="<?php echo $this->_tpl_vars['sort']['s_name']; ?>
" datatype="s" nullmsg="请填写车型名称！"/></td>
			</tr>
			<tr>
				<th>缩略图：</th>
				<td><input type="text" name="s_pic" id="url1" value="<?php echo $this->_tpl_vars['sort']['s_pic']; ?>
" />
...
">
						<input type="hidden" name="s_id" value="<?php echo $this->_tpl_vars['sort']['s_id']; ?>
">
