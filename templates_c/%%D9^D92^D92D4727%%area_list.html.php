<?php /* Smarty version 2.6.18, created on 2017-07-07 15:43:19
...
?m=area&a=add" class="add">添加省份</a></li>
		</ul>	
	</div>
</div>
...
<td align="right" width="130" class="rightmenu"><a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=area&a=add&parentid=<?php echo $this->_tpl_vars['arealist']['id']; ?>
">添加城市</a> <a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=area&a=edit&id=<?php echo $this->_tpl_vars['arealist']['id']; ?>
">编辑</a> <a href="javascript:if(confirm('确实要删除吗?'))location='<?php echo $this->_tpl_vars['adminpage']; ?>
?m=area&a=del&id=<?php echo $this->_tpl_vars['arealist']['id']; ?>
'">删除</a>
</td>
</tr>
...
" class="ip01"/></td>
 ...
 <?php if ($this->_tpl_vars['citylist']['isrecom'] == 1): ?><span class="red">[推荐]</span><?php endif; ?></td>
	<td align="right" width="80" class="rightmenu"><a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=area&a=recom&id=<?php echo $this->_tpl_vars['citylist']['id']; ?>
&isrecom=<?php if ($this->_tpl_vars['citylist']['isrecom'] == 1): ?>0<?php else: ?>1<?php endif; ?>"><?php if ($this->_tpl_vars['citylist']['isrecom'] == 1): ?>取消推荐<?php else: ?>推荐<?php endif; ?></a> <a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=area&a=edit&id=<?php echo $this->_tpl_vars['citylist']['id']; ?>
">编辑</a> <a href="javascript:if(confirm('确实要删除吗?'))location='<?php echo $this->_tpl_vars['adminpage']; ?>
?m=area&a=del&id=<?php echo $this->_tpl_vars['citylist']['id']; ?>
'">删除</a>
	</td>
	</tr>
...
?m=area&a=bulkdel','删除');" title="请选择后操作">删除</a> <a href="javascript:submitForm('<?php echo $this->_tpl_vars['adminpage']; ?>
?m=area&a=bulksort','更新排序');" title="请选择后操作">更新排序</a>
	</td>
</tr>
</table>
</form>
