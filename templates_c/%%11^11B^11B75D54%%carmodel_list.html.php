<?php /* Smarty version 2.6.18, created on 2017-07-07 14:17:12
...
?m=carmodel" method="post" name="form">
	<?php if ($this->_tpl_vars['types'] == 2): ?>
		...
		<tr><th width="30">选择</th><th>ID</th><th width="60">排序</th><th align="left">品牌</th><th align="left">型号</th><th>车型</th><th>款式</th><th>操作</th></tr>
...
"></td>
				<td align="center"><?php echo $this->_tpl_vars['brand']['styles_id']; ?>
</td>
                <td align="center"><input type="text" size="5" name="orderid[<?php echo $this->_tpl_vars['brand']['b_id']; ?>
]" value="<?php echo $this->_tpl_vars['brand']['styles_id']; ?>
" class="ip01"></td>
				<td align="left"><?php echo $this->_tpl_vars['brand']['brandname']; ?>
</td>
				<td align="left"><?php echo $this->_tpl_vars['brand']['seriesname']; ?>
</td>
				<td align="center"><?php echo $this->_tpl_vars['brand']['styles_name']; ?>
</td>
				<td align="center"><?php echo $this->_tpl_vars['brand']['styles_year']; ?>
</td>
                <td align="center" class="rightmenu"><a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=carmodel&a=editcarstyle&styles_id=<?php echo $this->_tpl_vars['brand']['styles_id']; ?>
" class="edit">编辑车型款式</a> | <a href="javascript:if(confirm('确实要删除款式以及款式下的所有车型吗?'))location='<?php echo $this->_tpl_vars['adminpage']; ?>
?m=carmodel&a=del&styles_id=<?php echo $this->_tpl_vars['brand']['styles_id']; ?>
'" class="del">删除车型款式</a></td> 
			</tr>
...
?>
				<tr bgcolor="#ffffff" onmouseover="style.backgroundColor='#E2E9EA'"  onmouseout="style.backgroundColor='#ffffff'">
                    <td align="center"><input type="checkbox" name="bulkid[]" value="<?php echo $this->_tpl_vars['brand']['styles_id']; ?>
"></td>
					<td align="center"><?php echo $this->_tpl_vars['brand']['styles_id']; ?>
</td>
                    <td align="center"><input type="text" size="5" name="orderid[<?php echo $this->_tpl_vars['brand']['styles_id']; ?>
]" value="<?php echo $this->_tpl_vars['brand']['styles_id']; ?>
" class="ip01"></td>
					<td align="left"><?php echo $this->_tpl_vars['brand']['brandname']; ?>
</td>
